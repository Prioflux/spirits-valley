                ...
                <div class="sm:col-span-2">
                  <div class="space-y-4">
                    ...
                    <ul class="flex space-x-5">
                      <li>
                        <a :href="company.website.url" target="_blank" title="Website" class="text-gray-400 hover:text-gray-500">
                          <span class="sr-only">Website</span>
                          <GlobeAltIcon />
                        </a>
                      </li>
                      <li v-if="company.facebook.url">
                        <a :href="company.facebook.url" target="_blank" title="Facebook" class="text-gray-400 hover:text-gray-500">
                      ...
                      <li v-if="company.linkedin.url">
                        <a :href="company.linkedin.url" target="_blank" title="LinkedIn" class="text-gray-400 hover:text-gray-500">
                      ...
                      <li v-if="company.instagram.url">
                        <a :href="company.instagram.url" target="_blank" title="Instagram" class="text-gray-400 hover:text-gray-500">
