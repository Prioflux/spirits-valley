<template>
  <div id="apero-contact">
    <div class="relative lg:px-20 c-container pt-52 pb-36">
      <div class="lg:flex">
        <div
          class="z-10 p-8 mx-auto shadow-lg  rounded-tl-xl rounded-tr-xl lg:absolute bg-opacity-90 bg-primary-stokerie lg:rounded-xl h-fit lg:top-20 lg:w-3/4 lg:left-4 lg:w-fit"
        >
          <div class="relative">
